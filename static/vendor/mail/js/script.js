    ...
    function attachFormValidator(elements) {
      ...
      var regularConstraintsMessages = [
        ...
        },
        {
          ...
          newMessage: "Esse email não é válido.",
        },
        {
        ...
        $form.attr("novalidate", "novalidate").ajaxForm({
          ...
          beforeSubmit: function (arr, $form, options) {
            ...
            if (isValidated(inputs, captcha)) {
                ...
                $.ajax({
                  ...
                  if (responceCode !== "CPT000") {
                    if (output.hasClass("snackbars")) {
                      output.html(
                        '<p><span class="s-icon fas fa-exclamation-triangle"></span><span>' +
              ...
              if (output.hasClass("snackbars")) {
                output.html(
                  '<p><span class="s-icon fa-spin fas fa-spinner"></span><span>Sending</span></p>'
                );
          ...
          success: function (result) {
            ...
            if (result === "MF000") {
              if (output.hasClass("snackbars")) {
                output.html(
                  '<p><span class="s-icon fas fa-check-circle"></span><span id="success">' +
                    msg[result] +
                    "</span></p>"
                );
              ...
              if (output.hasClass("snackbars")) {
                output.html(
                  ' <p class="snackbars-left"><span class="s-icon fas fa-exclamation-circle"></span><span>' +
                    msg[result] +
                    "</span></p>"
                );
                output.addClass("active error");
